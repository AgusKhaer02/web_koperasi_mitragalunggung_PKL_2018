<?php
    ...
    if ($_SESSION['Status'] == "Member")
    {
        echo"
        <script>
        alert('Anda bukan User silahkan logout dan login sebagai user');
        ...
        <tr>
            <td id="animate-fade" style="padding-bottom:40px;">
                ...
                switch ($leftindex)
                {
                    ...
                    break;
                    case 'Simpan':
                    include 'Halaman/Simpan.php';
                    break;
                    case 'LaporanSimpan';
                    include 'Halaman/laporansimpan.php';
                    break;
                    case 'CetakLaporanSimpan':
                    include 'Halaman/cetaklaporansimpan.php';
                    break;
                    case 'CetakLaporanPinjam':
                    include 'Halaman/cetaklaporanpinjam.php';
                    break;
                    case 'RiwayatTransaksi':
                    include 'Halaman/RiwayatTransaksi.php';
                    break;
                    case 'EditAnggota':
                    include 'Halaman/editanggota.php';
                    break;
                    //----------------------------------------
                    default :
...
<div class='profilearea'>
            ...
            <a href='menuutama.php?leftindex=Home' class='item_navigasi'>Home</a>
            <a href='menuutama.php?leftindex=Simpan' class='item_navigasi'>Simpan</a>
            <a href='menuutama.php?leftindex=Pinjam' class='item_navigasi'>Pinjam</a>
            <a href='menuutama.php?leftindex=RiwayatTransaksi' class='item_navigasi'>Riwayat Transaksi</a>
            <a href='menuutama.php?leftindex=CetakLaporanSimpan' class='item_navigasi'>Laporan Simpan</a>
            <a href='menuutama.php?leftindex=CetakLaporanPinjam' class='item_navigasi'>Laporan Pinjam</a>
            <a href='menuutama.php?leftindex=Daftaranggota' class='item_navigasi'>Daftar Anggota</a>
            <a href='menuutama.php?leftindex=SejarahKoperasi' class='item_navigasi'>Sejarah Koperasi</a>
            <a href='#' onmouseover='Visible()' onmouseout='Hidden()'style='cursor:pointer' class='item_navigasi'>Dan Lain Lain</a>
            <div id='dropdown-item' onmouseover='Visible()'onmouseout='Hidden()'>
                <a href='menuutama.php?leftindex=SuratKeputusan' class='item_navigasi'>Pengesahan Akta Pendirian</a>
                <a href='http://www.stmik-tasikmalaya.ac.id/' class='item_navigasi'>Go to official page</a>
            </div>
</div>
<div id='sidebutton'>
    <span id='btnOpenNav' onclick='openNav()' style='cursor:pointer;'>
